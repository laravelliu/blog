...
class WP_Customize_Nav_Menu_Location_Control extends WP_Customize_Control
{
    ...
    public function render_content()
    {
		...
		<button type="button" class="button-link create-menu<?php if ($this->value()) {
            echo ' hidden';
        } ?>" data-location-id="<?php echo esc_attr($this->location_id); ?>" aria-label="<?php esc_attr_e('Create a menu for this location'); ?>"><?php _e('+ Create New Menu'); ?></button>
