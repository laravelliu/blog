...
class Akismet_Admin
{
    ...
    public static function dashboard_stats()
    {
        ...
        echo '<p>'.sprintf(_n(
                ...
                $count,
            'akismet'
        ), 'https://akismet.com/wordpress/', esc_url(add_query_arg(array( 'page' => 'akismet-admin' ), admin_url(isset($submenu['edit-comments.php']) ? 'edit-comments.php' : 'edit.php'))), number_format_i18n($count)).'</p>';
    }
    ...
    public static function rightnow_stats()
    {
        if ($count = get_option('akismet_spam_count')) {
            $intro = sprintf(_n(
                ...
                $count,
                'akismet'
            ), 'https://akismet.com/wordpress/', number_format_i18n($count));
        } else {
    ...
    public static function display_notice()
    {
        ...
        } elseif (isset($_GET['akismet_recheck_complete'])) {
