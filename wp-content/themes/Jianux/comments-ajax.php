...
?>
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		<div id="comment-<?php comment_ID(); ?>" class="comment-body" style="border-bottom:0;">
					<div class="touxiang">
					<?php echo get_avatar($comment, $size = '52'); ?>
					</div>
		<div class="comment-head">
			<?php printf(__('<span class="name">%s</span>'), get_comment_author_link()); ?></span> : <?php comment_text() ?>
		   <div class="date"><?php comment_date('Y-m-d') ?> <?php comment_time() ?></div>
