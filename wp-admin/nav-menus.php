...
<div class="wrap">
	...
	<div id="menu-settings-column" class="metabox-holder<?php if (isset($_GET['menu']) && '0' == $_GET['menu']) {
				...
				<div class="menu-edit <?php if ($add_new_screen) {
					...
					<div id="post-body">
						<div id="post-body-content" class="wp-clearfix">
							...
							<div class="drag-instructions post-body-plain" <?php if (isset($menu_items) && 0 == count($menu_items)) {
                        ?>style="display: none;"<?php
							...
							<?php if ($add_new_screen) : ?>
								...
								<?php endif; ?>
							<?php endif; ?>
							<div class="menu-settings" <?php if ($one_theme_location_no_menus) {
                                ?>style="display: none;"<?php
                            } ?>>
